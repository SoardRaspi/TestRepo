...
f = open("Haptic Project 25.2 v2 log data.txt", "w")
...
# ### Trying the different Health Graphs ###
# # image = cv.imread('Haptic Things/SpO2_1.jpg')
# # image = cv.imread('Haptic Things/SpO2_1_bigger.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/SpO2_2.jpg')
# # image = cv.imread('Haptic Things/SpO2_2_bigger.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/SpO2_4.jpg')
# # image = cv.imread('Haptic Things/SpO2_4_bigger.jpeg')
# # image = cv.imread('Haptic Things/SpO2_4_bigger thinner kernel=3.jpeg')  # ✅
# # image = cv.imread('Haptic Things/SpO2_4_bigger thinner kernel=3 x2.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/EEG_3.jpg')
# # image = cv.imread('Haptic Things/EEG_3_bigger_1.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/EEG_4.jpg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1.jpeg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1 darker.jpeg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1 darker_1.jpg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1 darker_1 thinner kernel=3.jpeg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1 darker_1 thinner kernel=3 bigger_1.jpeg')
# # image = cv.imread('Haptic Things/EEG_4_bigger_1 darker_1 thinner kernel=3.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/SpO2_image.jpg')
# # image = cv.imread('Haptic Things/SpO2_image inverted.jpeg')
# # image = cv.imread('Haptic Things/SpO2_image inverted new thinner kernel=3.jpeg')
# # image = cv.imread('Haptic Things/SpO2_image inverted new thinner kernel=3 x3.jpeg')  # ✅
#
# # image = cv.imread('Haptic Things/ECG1.png')
# # image = cv.imread('Haptic Things/ECG1 bigger.jpeg')  # s
# # image = cv.imread('Haptic Things/ECG1 bigger thinner.jpeg')
# image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=3.jpeg')  # ✅
# # # image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=3 x3.jpeg')
# # # image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=3 x3 kernel=3.jpeg')
# # # # image = cv.imread('Haptic Things/ECG1 bigger kernel=3.jpeg')
# # # # image = cv.imread('Haptic Things/ECG1 bigger kernel=3 2.jpeg')
# # # # image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=3 thickened.jpeg')
# # # # image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=14.jpeg')
# # # # image = cv.imread('Haptic Things/ECG1 bigger thinner kernel=5.jpeg')
#
# # image = cv.imread('Haptic Things/SpO2_3.jpg')
# # image = cv.imread('Haptic Things/SpO2_3_bigger.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3_bigger_2.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3_bigger corroded kernel=3.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3_bigger_3 corroded kernel=3.jpeg')
# #
# # image = cv.imread('Haptic Things/SpO2_3 seg_1.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_1 thinner kernel=3.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_1 bigger.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_1 bigger thinner kernel=3.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_1 bigger thinner kernel=3 v2.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 bigger_4.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 bigger_4 thinner kernel=3.jpeg')
#
# # image = cv.imread('Haptic Things/SpO2_3 seg_2.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_3.jpeg')
# # image = cv.imread('Haptic Things/SpO2_3 seg_4.jpeg')
#
# # image = cv.imread('Haptic Things/EEG1.jpeg')
# # image = cv.imread('Haptic Things/EEG_1_bigger_1.jpeg')
#
# # image = cv.imread('Haptic Things/EEG_2.jpg')
# # image = cv.imread('Haptic Things/EEG_2 bigger.jpeg')
#
# # image = cv.imread('Haptic Things/EEG_5.jpg')
# # image = cv.imread('Haptic Things/EEG_5 bigger.jpeg')
# # image = cv.imread('Haptic Things/EEG_5 bigger_2.jpeg')
# # image = cv.imread('Haptic Things/EEG_5 bigger_2 thinner kernel=3.jpeg')
# # image = cv.imread('Haptic Things/EEG_5 bigger_2 thinner kernel=3 x4.jpeg')
#
# # image = cv.imread('Haptic Things/EEG_5_2.jpeg')
# # image = cv.imread('Haptic Things/EEG_5_2 bigger.jpeg')
# # image = cv.imread('Haptic Things/EEG_5_2 bigger x4.jpeg')
# # image = cv.imread('Haptic Things/EEG_5_2 bigger x4 thinner.jpeg')
# # # image = cv.imread('Haptic Things/EEG_5_2 bigger x4.jpeg thinner kernel=3.jpeg')
# #
# # # image = cv.imread('Haptic Things/EEG_5_2 bigger_2.jpeg')
# # # image = cv.imread('Haptic Things/EEG_5_2 bigger thinner.jpeg')
# # # image = cv.imread('Haptic Things/EEG_5_2 bigger thinner x3 kernel=3.jpeg')
# #
# # # # # image = cv.imread('Haptic Things/EEG_6.jpg')
# # # #
# # # # # image = cv.imread('Haptic Things/EEG_7.jpg')
#
# # image = cv.imread('Haptic Things/sample_image_2 SpO2.jpg')
# # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted.jpg')
# # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted thinner.jpg')
# # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted thinner x3.jpg')
# # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted thinner x7.jpg')
# # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted thinner x7 x2.jpg')
# # # image = cv.imread('Haptic Things/sample_image_2 SpO2 inverted thinner x7 x2 thinner kernel=3.jpg')
# # # image = cv.imread('Haptic Things/sample_image_2 SpO2 x3.jpg')
# # # image = cv.imread('Haptic Things/sample_image_2 SpO2 x3 smoothened k=10.jpg')
# # # image = cv.imread('Haptic Things/sample_image_2 SpO2 x3 smoothened k=3.jpg')
# ### ---------------------------------- ###
...
def points_filter(coord_curr, last_5, new_coords):
    points_refined = []

    return points_refined

def line_crossed(a, b, last_5):
    print("data from line_crossed:", a, b, last_5, file=f)
    flag_crossed = False
    x1, y1 = a
    x2, y2 = b

    pos_wrt_line = lambda coord_temp: (y2 - y1)*coord_temp[0] + (x1 - x2)*coord_temp[1] + (y1*(x2 - x1) + x1*(y2 - y1))

    # curr = 1
    init = 1

    if (len(last_5) == 0) or (last_5 is None):
        flag_crossed = False
        ...
        for i in range(len(last_5)):
            if flag_set is False:
                data_temp = pos_wrt_line(last_5[i])
                if data_temp != 0:
                    if data_temp < 0:
                        init = -1
...
def nearest_locator(IMG_F, intensity):
    ...
    print("list_coords:", list_coords, file=f)
...
# XO, YO = 212, 324
# XO, YO = 210, 324
print("[X, Y] from nearest function:", [XO, YO], file=f)
...
def HarrisCorners(COORDS_FINAL, IMAGE_FINAL):
    ...
    # print("colors_for_groups:", colors_for_groups, file=f)
    # print("coords_for_groups:", coords_for_groups, file=f)
...
print("coords_for_COI:", coords_for_COI, file=f)
...
def grapher_3D(SIZE, IMG_F, CX, CY,  SIZE_CONT=None):
    ...
    print("values_otherwise before del values[0]:", values_otherwise, file=f)
    print("values before del values[0]:", values, [CX, CY], file=f)
    ...
    end_grapher = timer()
    print("time for grapher_3D:", end_grapher - start_grapher, file=f)
...
def get_dirs_from_coords(traversed_last_5_local, _, __, ___, X, Y, PREV, HarrisCoord_ifany=None):
    cs = plt.contour(_, __, ___, colors='black')
    set_contours = {}
    ans = {}
    ...
    print("set_contours:", [X, Y], set_contours[0], file=f)
    ...
    for ii in range(len(set_contours[0])):
        print("data_ii_cont:", set_contours[0][ii], file=f)
    ...
    print("COI_boundary_dirs at:", [X, Y], COI_boundary_dirs, file=f)
    # # print("coord_index_temp:", [X, Y], coord_index_temp)
    # # print("pp:", [X, Y], pp)
    print("cycle2:", [X, Y], cycle2, file=f)
    ...
    print("coords_result_temp in get_dirs_from_coords:", [X, Y], coords_result_temp, file=f)

    distance_by_coord_result_temp = {}
    for i in range(len(coords_result_temp)):
        distance_by_coord_result_temp[i] = 0

    for coord_past in traversed_last_5_local:
    ...
    print("ans after COI_boundary_dirs[curr_index_boundary] at:", [X, Y], ans, file=f)
    ...
    # traversed_last_5_copy = traversed_last_5_local.copy()
    # if HarrisCoord_ifany is not None:
    #     traversed_last_5_copy.append(HarrisCoord_ifany)
    #
    # # print("traversed_last_5_copy:", [X, Y], traversed_last_5_local)

    for key in ans:
        a, mid, b = ans[key]

        # if line_crossed(a, b, traversed_last_5_local) is False:
        if True:
        # if mid[0] >= X:
            _0.append(mid)

    print("_0 data at:", [X, Y], " _~_ ", _0, file=f)
    ...
    #
    #             # print("traversed_last_5_local:", [X, Y], traversed_last_5_local)
    #
    #             distance_by_coord_result_temp = {}
    #
    #             for coord in traversed_last_5_local:
...
def find_max_perp(point, beta_bar, img_f, limit, length=13):
    ...
    print("data from find_max_perp at pre:", point, thickness, a, b, file=f)
    thickness /= 2
    ...
    print("all data from find_max_perp:", u_xc, l_xc, u_yc, l_yc, "possible:", possible, file=f)
    ...
    print("data after first median_from_possible operation:", median_from_possible, file=f)
    ...
    if median_from_possible is None:
        ...
        print("data after first median_from_possible operation if it was None:", median_from_possible, file=f)

    print("data from find_max_perp at:", point, "thickness:", thickness, "final point:", median_from_possible,
          "beta_perp:", beta_perp, file=f)

    # ------------------------------------------------------------------------------------------------------------------

    end_fmp = timer()
    print("time taken for fmp:", end_fmp - start_fmp, file=f)
...
#                 ################################################################################
#                 _, __, ___, X1, Y1 = grapher_3D(13, image_final, CX, CY, CONT_KERNEL_SIZE_GLOBAL)
#                 traversed_last_5_copy = traversed_last_5.copy()
#                 # traversed_last_5_copy.append([CX, CY])
#
#                 directions, pp, len_conts, angle, _0 = get_dirs_from_coords(traversed_last_5_copy, _, __, ___, X1, Y1, None,
#                                                                             HarrisCoord_ifany=[CX, CY])
#
#                 # print("_0 data:", [CX, CY], [X1, Y1], _0)
#                 ################################################################################
#
...
#                             _, __, ___, X1, Y1 = grapher_3D(13, image_final, CX, CY, CONT_KERNEL_SIZE_GLOBAL)
#                             traversed_last_5_copy = traversed_last_5.copy()
#                             # traversed_last_5_copy.append([coords_for_COI[index_mm]])
#
#                             directions, pp, len_conts, angle, _0 = get_dirs_from_coords(traversed_last_5_copy, _, __, ___, X1,
#                                                                                         Y1, None,
#                                                                                         HarrisCoord_ifany=[CX, CY])
#
#                             # print("_0 data:", [CX, CY], [X1, Y1], _0)
...
#         degs = []
#
#         points_possible_temp = []
#         points_possible_fQS_temp = []
#
#         for item in points_possible:
#             if item not in points_possible_temp:
#                 points_possible_temp.append(item)
#
#         for item in points_possible_fQS:
#             if item not in points_possible_fQS_temp:
#                 points_possible_fQS_temp.append(item)
#
#         points_possible = points_possible_temp
#         points_possible_fQS = points_possible_fQS_temp
#
#         del points_possible_temp
#         del points_possible_fQS_temp
#
...
#                         # if True:
#                         # print("direction_pointing == direction_general_fQS is true")
#
#                         if direction_pointing == 'SE':
#                             if (curr[1] <= CY):
#                                 direction_pointing = 'NW'
...
#
#         # print("data from dirLR_ß at:", [CX, CY], final_point_fQS, final_direction_fQS)
#
...
#         # if not flag_curr_Harris:
#         if True:
#             # # print("returned from dirLR_ß when flag_curr_Harris is False")
...
#                     direction_pointing = 'W'
#
#             final_direction_fQS.append(direction_pointing)
#
#         # print("data from dirLR_ß when flag_curr_Harris is True at:", [CX, CY], final_point_fQS, final_direction_fQS)
#
#         # return beta_bar, angle, direction, None
#         # return beta_bar, angle, final_direction, final_point
#         return beta_bar_fQS, None, final_direction_fQS, final_point_fQS

def dirLR_β(IMG_F, CX, CY, KER_SIZE, LIMIT, PREV, PREV_COORDS=None, IGNORE_HARRIS=False):
    _0 = []
    index_mm = None
    direction_pointing_test = None

    if PREV_COORDS:
        theta_radians = np.arctan2(CY - PREV_COORDS[1], CX - PREV_COORDS[0])

        angle_new_format = theta_radians / np.pi

        if ((angle_new_format >= 0.125) and (angle_new_format <= 0.375)) or \
                ((angle_new_format >= -0.875) and (angle_new_format <= -0.625)):
            direction_pointing_test = 'SE'
        elif ((angle_new_format >= 0.375) and (angle_new_format < 0.625)) or \
                ((angle_new_format > -0.625) and (angle_new_format < -0.375)):
            direction_pointing_test = 'S'
        elif ((angle_new_format >= 0.625) and (angle_new_format <= 0.875)) or \
                ((angle_new_format >= -0.375) and (angle_new_format <= -0.125)):
            direction_pointing_test = 'SW'
        elif ((angle_new_format >= 0) and (angle_new_format < 0.125)) or \
                ((angle_new_format >= -1) and (angle_new_format < -0.875)) or \
                ((angle_new_format > 0.875) and (angle_new_format <= 1)) or \
                ((angle_new_format > -0.125) and (angle_new_format < 0)):
            # ((angle_new_format < -0.125) and (angle_new_format > 0)):
            direction_pointing_test = 'E'

        # print('direction_pointing before:', direction_pointing)

        if direction_pointing_test == 'SE':
            if CY <= PREV_COORDS[1]:
                direction_pointing_test = 'NW'
        elif direction_pointing_test == 'S':
            if CY <= PREV_COORDS[1]:
                direction_pointing_test = 'N'
        elif direction_pointing_test == 'SW':
            if CY <= PREV_COORDS[1]:
                direction_pointing_test = 'NE'
        elif direction_pointing_test == 'E':
            if CX <= PREV_COORDS[0]:
                direction_pointing_test = 'W'

    start_dirLR = timer()
    print("reached dirLR_ß at:", [CX, CY], "with params:", KER_SIZE, LIMIT, PREV, IGNORE_HARRIS, PREV_COORDS, direction_pointing_test, IGNORE_HARRIS, file=f)

    # if direction_pointing_test is not None:
    #     PREV = direction_pointing_test
    ...
    if IGNORE_HARRIS == False:
        if type(maintainer_matrix[CY][CX]) == str:
            if maintainer_matrix[CY][CX][0] == "h":
                ...
                print("Harris early detected at:", [CX, CY], [coords_for_COI[index_mm]], file=f)
                # f.write("Harris early detected at:" + " " + str([CX, CY]) + " " + str([coords_for_COI[index_mm]]) + "\n")
                ...
                print("_0 data:", [CX, CY], [X1, Y1], _0, file=f)
                ################################################################################
    ...
    if IGNORE_HARRIS == False:
        for X, Y, VAL in final_QS:
            if flag_curr_Harris == False:
                ...
                try:
                    if val_mm[0] == "h":
                        print("val_mm in dirLR_ß:", [CX, CY], val_mm, file=f)
                except:
                    pass
                ...
                if type(val_mm) == str:
                    if val_mm[0] == "h":
                        ...
                        _, __, ___, X1, Y1 = grapher_3D(13, image_final, coords_for_COI[index_mm][0], coords_for_COI[index_mm][1], CONT_KERNEL_SIZE_GLOBAL)
                        directions, pp, len_conts, angle, _0 = get_dirs_from_coords(traversed_last_5, _, __, ___, X1,
                                                                                    Y1, None)
    ...
    if direction_general_fQS == 'E':
        ...
        print("max_dist_point at:", [CX, CY], max_dist_point, beta_bar_fQS, beta_bar_fQS_perp, file=f)
        print("d_l and d_pl data at:", [CX, CY], d_l, d_pl, file=f)
        ...
        if d_pl < d_l:
            ...
            print("correction applied at:", [CX, CY], direction_general_fQS, file=f)
    ...
    if True:
        for x, y, _ in final_QS:
            try:
                ...
                print("error in divide by 0 in fQS:", beta_bar_fQS, beta_bar_num_fQS, beta_bar_denom_fQS, file=f)
                # pass

    # direction_list = []
    degs = []

    print("points_possible in dirLR:", [CX, CY], points_possible, file=f)
    print("points_possible in dirLR fQS:", [CX, CY], points_possible_fQS, file=f)
                    ...
                    if True:
                        ...
                        if direction_pointing not in direction_list_temp_fQS:
                            ...
                            try:
                                ...
                                print("error in direction_list_coord_fQS:", direction_list_coord_fQS, file=f)
                                # pass
    ...
    print("points_possible_fQS, direction_list_fQS from dirLR at:", [CX, CY], direction_list_temp_fQS,
          points_possible_fQS, flag_COI,
          direction_general_fQS, angle_fQS, beta_bar_num_fQS, beta_bar_denom_fQS, file=f)
    ...
    if True:
        print("points_possible_fQS from dirLR:", [CX, CY], PREV, points_possible_fQS, direction_list_temp_fQS, file=f)

        # if len(points_possible_fQS) != 0:
        if True:
            for i in range(len(direction_list_temp_fQS)):
                print("reached inside for loop at:", [CX, CY], direction_list_temp_fQS[i], points_possible_fQS[i], file=f)
                direction = direction_list_temp_fQS[i]
                if PREV and (direction != opp[PREV]):
                    final_direction_fQS.append(direction)
            ...
            print("final data from dirLR at fQS:", [CX, CY], final_direction_fQS, final_point_fQS, beta_bar_fQS, file=f)
    ...
    print("PREV_COORDS data from dirLR_ß at:", [CX, CY], PREV_COORDS, final_direction_fQS, final_point_fQS, file=f)
    ...
    end_dirLR = timer()
    print("time taken for dirLR_ß:", end_dirLR - start_dirLR, file=f)
    ...
    if flag_curr_Harris != False:
        ...
        for coord__0 in _0:
            ...
            # if True:
            if flag_curr_Harris == 1:
                theta_radians = np.arctan2(curr[1] - CY, curr[0] - CX)
            else:
                theta_radians = np.arctan2(curr[1] - coords_for_COI[index_mm][1], curr[0] - coords_for_COI[index_mm][0])
            ...
            if flag_curr_Harris == 1:
                ...
                if direction_pointing == 'SE':
                    if curr[1] <= coords_for_COI[index_mm][1]:
                        direction_pointing = 'NW'
                elif direction_pointing == 'S':
                    if curr[1] <= coords_for_COI[index_mm][1]:
                        direction_pointing = 'N'
                    ...
                    if curr[0] <= coords_for_COI[index_mm][0]:
                        direction_pointing = 'W'

            final_direction_fQS.append(direction_pointing)

        print("data from dirLR_ß when flag_curr_Harris is True at:", [CX, CY], final_direction_fQS, final_point_fQS, file=f)
...
# print("terminal_coords:", terminal_coords, file=f)
# print("Harris_corners_directions:", Harris_corners_directions, file=f)
...
def mainFunction2(X, Y, PREV, DIRECTIONS, POINT_NEXT=None, prev_coords=None):
    # if [X, Y] not in traversed_last_5:
    if [X, Y] not in total:
        total.append([X, Y])
        ...
        print(Fore.GREEN + "ans_ans_ans:", [X, Y], PREV, DIRECTIONS, POINT_NEXT, Style.RESET_ALL, file=f)
        ...
        if len(DIRECTIONS) == 0:
            print("reached len(DIRECTIONS)=0 point", file=f)
            ...
            if True:
                ...
                if flag_terminal_coord is True:
                    print("len(DIRECTIONS)=0Error -seems to be terminal_coord- end of current iteration at:", [X, Y], file=f)
                    if traversed_new_temp != []:
                        traversed_new.append(traversed_new_temp)
                        traversed_new_temp = []

                else:
                    print("len(DIRECTIONS)=0Error false end detected at:", [X, Y], file=f)
                    if traversed_new_temp != []:
                        traversed_new.append(traversed_new_temp)
                        traversed_new_temp = []
                    ...
                    directions, pp, len_conts, angle, coords_for_next_dirs = get_dirs_from_coords(traversed_last_5, _, __,
                                                                                                  ...
                                                                                                  None)
    # kkk
                    print("coords after false end detected:", [X, Y], coords_for_next_dirs, file=f)
            ...
            print("reached len(DIRECTIONS) = 1 point", file=f)
            ...
            # if True:
                ...
                print("data len(DIRECTIONS) == 1 at:", [X, Y], beta_bar_testing, directions_testing, points_testing, PREV,
                      opp[PREV] if PREV is not None else "None", "DIRECTIONS is: ", DIRECTIONS, file=f)
                ...
                if True:
                    if beta_bar_testing:
                        if len(directions_testing) == 0:
                            ...
                            print("data len(DIRECTIONS) temp == 1 at:", [X, Y], beta_bar_testing, directions_testing,
                                  points_testing, PREV,
                                  opp[PREV] if PREV is not None else "None", "DIRECTIONS is: ", DIRECTIONS, file=f)
                        ...
                        if len(directions_testing) > 1:
                            print("len(directions_testing) > 1 at:", PREV, [X, Y], directions_testing, file=f)
                            print("hence checking for opp2 dictionary...", file=f)
                            ...
                            print("next_dir_temp found after len(directions_testing) > 1:", next_dir_temp,
                                  next_dir_coords_list, file=f)

                            if len(next_dir_temp) > 1:
                                print("len(next_dir_temp) > 1 some error occurred in dirLR at:", [X, Y], directions_testing,
                                      next_dir_temp, next_dir_temp, next_dir_coords_list, file=f)

                                for key_nxt_coord in range(len(next_dir_coords_list)):
                                    try:
                                        X_Temp, Y_Temp = next_dir_coords_list[key_nxt_coord]

                                        # # print("data before applying dirLR_β at:", [X_Temp, Y_Temp], [X1, Y1], directions[i], "at harris:", points_testing)
                                        # print("data before applying dirLR_β at:", [X_Temp, Y_Temp], "[X1, Y1]",
                                        #       key_nxt_coord,
                                        #       "at harris:", points_testing, file=f)
                                        ...
                                        mainFunction2(X_Temp, Y_Temp, next_dir_temp[key_nxt_coord],
                                                      [next_dir_temp[key_nxt_coord]], prev_coords=[X, Y])
                                ...
                                print("if len(next_dir_temp) > 1 is not true values:", [X, Y],
                                      [beta_bar_testing, angle_testing, directions_testing, points_testing], file=f)
                            ...
                            #     # print("len(directions_testing) == 0 some error occurred in dirLR at:", [X, Y], points_testing)
                                ...
                                print("relocated point at:", [X, Y], "is:", [X_Reloc, Y_Reloc], file=f)
                                ...
                                if (X_Reloc != X) or (Y_Reloc != Y):
                                    ...
                                    if flag_terminal_coord is True:
                                        print("Seems like a terminal point at:", [X, Y], "Relocated point:",
                                              [X_Reloc, Y_Reloc], file=f)

                                    else:
                                        print("Dunno if a terminal point at:", [X, Y], "Relocated point:",
                                              [X_Reloc, Y_Reloc], file=f)

                                        beta_bar_testing, angle_testing, directions_testing, points_testing = dirLR_β(
                                            image_final, X_Reloc, Y_Reloc, KERNEL_SIZE_GLOBAL, LIMIT_VAL_GLOBAL, PREV,
                                            PREV_COORDS=prev_coords)
                                        print("applied dirLR_ß again after Dunno at:", [X, Y], [X_Reloc, Y_Reloc],
                                              beta_bar_testing, directions_testing, points_testing, file=f)

                                        _, __, ___, X1, Y1 = grapher_3D(13, image_final, X_Reloc, Y_Reloc,
                                                                        CONT_KERNEL_SIZE_GLOBAL)
                                        directions, pp, len_conts, angle, coords_for_next_dirs = get_dirs_from_coords(
                                            traversed_last_5, _, __, ___, X1, Y1, None)
                                        print("applied get_dir_from_coords again after Dunno at:", [X, Y],
                                              [X_Reloc, Y_Reloc], directions, coords_for_next_dirs, file=f)

                            except:
                                print("some error at line 2620", file=f)
                                # pass
                        ...
                        if len(points_testing) != 0:
                            if type(points_testing[0]) == int:
                                points_testing = [points_testing]
                                directions_testing = [directions_testing]

                            if PREV and (opp[PREV] in directions_testing):
                                del points_testing[directions_testing.index(opp[PREV])]
                                directions_testing.remove(opp[PREV])


                            # # print("multiple directions here at:", points_testing, directions, coords_for_next_dirs)
                            print("multiple directions here at:", points_testing, directions_testing, file=f)
                            ...
                            for key_nxt_coord in range(len(points_testing)):
                                ...
                                # if True:
                                    ...
                                    # mainFunction2(X_Temp, Y_Temp, key_nxt_coord, [directions_testing[0]], prev_coords=[X, Y])
                                    mainFunction2(X_Temp, Y_Temp, directions_testing[key_nxt_coord], [directions_testing[key_nxt_coord]], prev_coords=[X, Y])
                            ...
                            print("no points returned from points_testing at:", [X, Y])
                            pass

            except Exception as e:
                print("error new line 1852 at:", [X, Y], "Exception is:", e)
                print("sequence abort:", traversed_new)

                seq_recursive.append(traversed_new)

                # start_sequence(sequence_m=traversed_new, original_size=max(len(image_final), len(image_final[0])),
                #                original_beta=None, original_point=None)

                # sys.exit(0)
                # quit(0)

                # print("trying dirLR_ß again with new direction")
                # theta_radians = np.arctan2(CY - PREV_COORDS[1], CX - PREV_COORDS[0])
                #
                # angle_new_format = theta_radians / np.pi
                #
            ...
            try:
            # if True:
                print("reached absolute else point", file=f)
                print("new data before anything starts:", DIRECTIONS, POINT_NEXT, len(POINT_NEXT), file=f)

                if type(POINT_NEXT[0]) is int:
                    POINT_NEXT = [POINT_NEXT]
                    DIRECTIONS = [DIRECTIONS]

                print("new data before anything starts after len(POINT_NEXT) check:", DIRECTIONS, POINT_NEXT, file=f)

                for direction_index in range(len(DIRECTIONS)):
                # for direction_index in range(len(POINT_NEXT)):
...
print("before starting:", [XO, YO], [X1, Y1], directions, direction_testing, point_testing, beta_bar_testing, file=f)
print("before starting 2:", [XO, YO], [X1, Y1], _____, file=f)

start2 = timer()
mainFunction2(X1, Y1, None, direction_testing, POINT_NEXT=point_testing, prev_coords=None)
# mainFunction2(X1, Y1, None, direction_testing, POINT_NEXT=_____, prev_coords=None)
# mainFunction2(XO, YO, None, direction_testing, POINT_NEXT=point_testing, prev_coords=None)
end2 = timer()

# print(len(seq_recursive))
# print(seq_recursive[-1])
...
traversed_new.append(traversed_new_temp)
print("time taken for mainFunction2:", end2 - start2, file=f)

print(juncs, file=f)
print("centers:", centers, file=f)
print("centers_traversing:", centers_traversing, file=f)

plt.figure("image_final_Harris")
plt.xticks(np.linspace(0,len(image_final_Harris[0]),len(image_final_Harris[0])))
plt.yticks(np.linspace(0,len(image_final_Harris),len(image_final_Harris)))
plt.imshow(image_final_Harris)
...
print("time taken for program to run:", end - start, file=f)
print("time taken for terminal loop to run:", end_terminal - start_terminal, file=f)
...
print("count_z:", count_z, file=f)

# while True:
if True:
    print("------------------------------------------------------------", file=f)
    print("------------------------OUTPUT IMAGE------------------------", file=f)
    print("------------------------------------------------------------", file=f)
    ...
    start_sequence(sequence_m=traversed_new, original_size=(len(image_final), len(image_final[0])),
    ...
    end_timer_final = timer()

    print("time taken:", end_timer_final - start)
    ...
    print("Harris_at_prints:", Harris_at_prints, file=f)
